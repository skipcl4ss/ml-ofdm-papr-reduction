...
# fixed: no longer gives the exact same values as pred_norm, since it now has access to the original data minmax
...
# done: experiment with changing this architecture
